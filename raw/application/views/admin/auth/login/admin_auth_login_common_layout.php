...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <div class="form-group has-feedback">
            <input type="text" class="form-control" placeholder="<?php echo @$string['login_identity'] ?>" name="identity">
            <span class="glyphicon glyphicon-envelope form-control-feedback"></span>
        </div>
        <div class="form-group has-feedback">
            <input type="password" class="form-control" placeholder="<?php echo @$string['login_password'] ?>" name="password">
