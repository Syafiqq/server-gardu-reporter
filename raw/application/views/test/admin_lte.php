 ...
 * Name         : syafiq
 * Date / Time  : 20 June 2017, 4:17 PM.
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="/assets/vendor/AdminLTE/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
                                                <small>
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/assets/vendor/AdminLTE/dist/img/user2-160x160.jpg" class="user-image" alt="User Image">
...
<script src="/assets/vendor/AdminLTE/dist/js/demo.min.js"></script>
</body>
</html>
