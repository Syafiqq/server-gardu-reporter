 ...
 * Name         : syafiq
 * Date / Time  : 06 August 2017, 6:07 PM.
...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/layout/rekap/pengukuran/beban/imbang/admin/rekap_pengukuran_beban_imbang_admin_common_layout.min.css">
                        ...
                        <div class="panel-body">
                            <table id="tabel_pengukuran" class="table table-bordered table-hover table-striped">
                                ...
                                <tr>
                                    ...
                                    <th><?php echo $string['tabel']['header']['mean']; ?></th>
                                    <th><?php echo $string['tabel']['header']['const_a']; ?></th>
                                    <th><?php echo $string['tabel']['header']['const_b']; ?></th>
                                    <th><?php echo $string['tabel']['header']['const_c']; ?></th>
...
<script type="text/javascript" src="/assets/js/layout/rekap/pengukuran/beban/imbang/admin/rekap_pengukuran_beban_imbang_admin_common_layout.min.js"></script>
</body>
</html>
