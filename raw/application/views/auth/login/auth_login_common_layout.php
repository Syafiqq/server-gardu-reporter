...
<head>
    ...
    <!-- Custom -->
    <link rel="stylesheet" href="/assets/css/layout/auth/login/auth_login_common_layout.min.css">
...
<script type="text/javascript" src="/assets/js/layout/auth/login/auth_login_common_layout.min.js"></script>
</body>
</html>
