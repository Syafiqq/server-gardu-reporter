...
class Gardu extends \Restserver\Libraries\MY_REST_Controller
{
    ...
    public function induk_register_post()
    {
        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin())
        {
            ...
            $this->callback_request['_id_existence_check_need_exists'] = false;
    ...
    public function induk_update_patch()
    {
        ...
        if ($this->ion_auth->logged_in() && $this->ion_auth->is_admin())
        {
            ...
            $this->callback_request['_id_existence_check'] = true;
            $this->callback_request['_id_existence_check_need_exists'] = true;
    ...
    public function _id_existence_check($id)
    {
        ...
        else
        {
            ...
            $need_exist = isset($this->callback_request['_id_existence_check_need_exists']) ? $this->callback_request['_id_existence_check_need_exists'] : false;
            $id = intval($id);
            ...
            else
            {
                ...
                {
                    $this->lang->load('layout/gardu/induk/gardu_induk_common', $this->language);
                    $this->form_validation->set_message('_id_existence_check', $this->lang->line('gardu_induk_common_form_id_not_exists_error'));
