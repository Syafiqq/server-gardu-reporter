...
class Rekap extends CI_Controller
{
    ...
    {
        $this->lang_prefix      = 'rekap_pengukuran_gardu_member';
        $this->lang_layout      = 'common_layout';
        $this->lang_prefix_path = 'rekap/pengukuran/gardu/member';
        $this->lang->load("layout/{$this->lang_prefix_path}/{$this->lang_prefix}_{$this->lang_layout}", $this->language);
        $this->lang->load("layout/rekap/pengukuran/gardu/rekap_pengukuran_gardu_common", $this->language);
    ...
    {
        $this->lang_prefix      = 'rekap_pengukuran_tegangan_ujung_member';
        $this->lang_layout      = 'common_layout';
        $this->lang_prefix_path = 'rekap/pengukuran/tegangan/ujung/member';
        $this->lang->load("layout/{$this->lang_prefix_path}/{$this->lang_prefix}_{$this->lang_layout}", $this->language);
        $this->lang->load("layout/rekap/pengukuran/tegangan/ujung/rekap_pengukuran_tegangan_ujung_common", $this->language);
    ...
    {
        $this->lang_prefix      = 'rekap_pengukuran_beban_trafo_member';
        $this->lang_layout      = 'common_layout';
        $this->lang_prefix_path = 'rekap/pengukuran/beban/trafo/member';
        $this->lang->load("layout/{$this->lang_prefix_path}/{$this->lang_prefix}_{$this->lang_layout}", $this->language);
        $this->lang->load("layout/rekap/pengukuran/beban/trafo/rekap_pengukuran_beban_trafo_common", $this->language);
    ...
    private function _pengukuran_beban_imbang_admin()
    {
        ...
        if ($this->ion_auth->logged_in() && ($this->group === 'admin'))
        {
            ...
            $string['tabel']['header']['is']              = 'Arus S';
            $string['tabel']['header']['it']              = 'Arus T';
            $string['tabel']['header']['mean']            = 'Rata-rata';
            $string['tabel']['header']['const_a']         = 'Const a';
            $string['tabel']['header']['const_b']         = 'Const b';
            $string['tabel']['header']['const_c']         = 'Const c';
            $string['tabel']['header']['percent']         = 'Prosen Imbang';
            $string['tabel']['header']['status']          = 'Status Beban';


            $string['button']['download']                    = 'Unduh';
            $string['form']['label']['title']['filter_date'] = 'Pencarian';

            $meta['retriever']      = site_url('/api/rekap/pengukuran/beban/imbang/find?code=318A3');
            $meta['download']       = site_url('/api/rekap/pengukuran/beban/imbang/download');
            $meta['datatable_lang'] = base_url($this->lang->line('common_datatable_lang'));
    ...
    {
        $this->lang_prefix      = 'rekap_pengukuran_beban_imbang_member';
        $this->lang_layout      = 'common_layout';
        $this->lang_prefix_path = 'rekap/pengukuran/beban/imbang/member';
        $this->lang->load("layout/{$this->lang_prefix_path}/{$this->lang_prefix}_{$this->lang_layout}", $this->language);
        $this->lang->load("layout/rekap/pengukuran/beban/imbang/rekap_pengukuran_beban_imbang_common", $this->language);
