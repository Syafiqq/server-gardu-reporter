 ...
 * Name         : syafiq
 * Date / Time  : 06 August 2017, 12:38 PM.
                        ...
                        if (response['data']['rekap_pengukuran_beban_trafo'] !== undefined)
                        {
                            ...
                            for (i = table.data().count() - 1, is = contents.length; ++i < is;)
                            {
                                ...
                                table.row.add([
                                    ...
                                    content['longitude'],
                                    content['date'],
                                    moment(moment.utc(content['date'], "YYYY-MM-DD")).tz('Asia/Jakarta').format('dddd, D MMMM YYYY'),
                                    moment(moment.utc(content['time'], "HH:mm:ss")).tz('Asia/Jakarta').format('HH:mm:ss zz'),
                                    content['f'],
                                    content['ir'],
                                    content['is'],
                                    content['it'],
